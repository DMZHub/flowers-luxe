...
export default function Home() {
  ...
  // Featured products IDs to display
  const featuredProductIds = [1, 2, 29, 34]
  
  // Filter products to get just the requested ones in the specified order
  ...
  // Blog posts - using the requested ones
  const blogPosts = [
    {
    ...
    },
    {
      ...
      excerpt: 'Discover beautiful flowers that are safe for your feline friends. Learn which plants to choose for a cat-friendly home that combines natural beauty with pet safety.',
