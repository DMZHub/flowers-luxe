...
import { FiHome, FiShoppingBag, FiFileText, FiInfo, FiMenu, FiX, FiExternalLink } from 'react-icons/fi'
...
export default function Header() {
  ...
  const navItems: NavItem[] = [
    ...
    { name: 'Shop', url: '/shop', icon: FiShoppingBag },
    { name: 'Blog', url: '/blog', icon: FiFileText },
    { name: 'About', url: '/about', icon: FiInfo },
    { name: 'TeePublic Store', url: 'https://store.flowersluxe.com', icon: FiExternalLink, external: true }
  ]
